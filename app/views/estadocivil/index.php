...
<div class="container">
    ...
    <a href="/microsoftajeo/app/views/estadocivil/create.php"><button>Agregar</button></a>
            ...
            <?php if (!empty($estadosciviles) && is_array($estadosciviles)): ?>
                <?php foreach ($estadosciviles as $estadocivil): ?>
                    <tr>
                        ...
                        <td>
                            <a href="/microsoftajeo/public/estadocivil/edit?idestadocivil=<?php echo htmlspecialchars($estadocivil['idestadocivil']); ?>">
                                <button>Editar</button>
                            </a>
                            <a href="/microsoftajeo/public/estadocivil/eliminar?idestadocivil=<?php echo htmlspecialchars($estadocivil['idestadocivil']); ?>"
